...
// --- NOTE: Removed duplicate Campaign and Template struct definitions below ---
// --- Ensure Campaign and Template structs are defined elsewhere in the models package (e.g., campaign.go, template.go) ---
