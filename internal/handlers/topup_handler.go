...
func (h *TopupHandler) GetTopupByID(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"error": "Topup not found"})
		return
	}
...
func (h *TopupHandler) GetTopupsByMSISDN(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get topups"})
		return
	}
...
func (h *TopupHandler) CreateTopup(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to create topup"})
		return
	}
...
func (h *TopupHandler) ProcessTopups(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to process topups"})
		return
	}
...
func (h *TopupHandler) GetTopupCount(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get topup count"})
		return
	}
