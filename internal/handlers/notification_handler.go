...
func (h *NotificationHandler) GetNotificationCount(c *gin.Context) {
	// Get notification count
	 ...
	 if err != nil {
		 c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get notification count: " + err.Error() })
		 return
	 }
...
func (h *NotificationHandler) GetCampaignCount(c *gin.Context) {
	// Get campaign count
	 ...
	 if err != nil {
		 c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get campaign count: " + err.Error() })
		 return
	 }
...
func (h *NotificationHandler) GetTemplateCount(c *gin.Context) {
	// Get template count
	 ...
	 if err != nil {
		 c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to get template count: " + err.Error() })
		 return
	 }
